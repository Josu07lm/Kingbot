		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerB: '[❗] Josue? Este es un recurso especial para Josue ❌',
					...
					admin: '[❗] Este comando sólo puede ser usado por los administradores del grupo! ❌',
					Badmin: ' [❗] Este comando solo puede ser usado cuando el bot es administrador del grupo! ❌',
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["593992390339@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"593992390339@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["593992390339@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["593992390339@s.whatsapp.net"]//ubah nomor lo
			const premium = ["593992390339@s.whatsapp.net","558296156440@s.whatsapp.net"] 
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("En este grupo, no nos gusta el racismo, que esto sirva de ejemplo 🚶")
		}, 4000)
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("2 segundos")
...
//@darkYT					
    ...
    break
				...
				case 'premiumlist':
					...
					break
                  case 'qrcode':
        			if (!isPremium) return reply('Usted no es un Miembro Premium, póngase en contacto con el propietario o escriba *. Daftarvip* para adquirir acceso Premium!!' ,text, { quoted: mek })
